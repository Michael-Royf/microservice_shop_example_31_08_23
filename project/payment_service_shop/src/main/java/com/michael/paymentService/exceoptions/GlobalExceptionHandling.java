package com.michael.paymentService.exceoptions;


import com.michael.paymentService.exceoptions.payload.PaymentNotFoundException;
import com.michael.paymentService.payload.response.ExceptionResponse;
...
public class GlobalExceptionHandling extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ExceptionResponse> handleMethodOrderNotFoundException(PaymentNotFoundException ex) {
